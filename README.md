...
- `NEXT_PUBLIC_ENABLE_LINEA_CONSENSUS=1` enables experimental Linea consensus support
- When disabled, Linea generates partial packages with explicit reason codes
